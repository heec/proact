...
function createRenderer(options) {
  ...
  return {
    ...
    renderToString: function (component, context, options) {
      const _self = this
      return new Promise(function (resolve, reject) {
        try {
          const stringBuffer = createStringBuffer()
          _self
            .renderToStream(component, context, stringBuffer, options)
            .then(function () {
    ...
    renderToStream: function (component, context, stream, options) {
      const _self = this
      return new Promise(function (resolve, reject) {
